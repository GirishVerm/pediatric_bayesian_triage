#!/usr/bin/env python3
"""
Build script to create standalone executable for IATRO
...
def build_executable():
    ...
    cmd = ["pyinstaller", "--clean", "IATRO.spec"]
    
    print("\nUsing IATRO.spec for building...")
    if system == "Darwin":
        print("After building, you can create a .dmg using:")
        print("  cd dist")
        print("  hdiutil create -volname IATRO -srcfolder IATRO -ov -format UDZO IATRO.dmg")
    ...
    try:
        ...
        print(f"\nExecutable location:")
        if system == "Darwin":
            print("  dist/IATRO/IATRO")
            print("\nTo create a .dmg file:")
            print("  cd dist")
            print("  hdiutil create -volname IATRO -srcfolder IATRO -ov -format UDZO IATRO.dmg")
        elif system == "Windows":
            print("  dist/IATRO.exe")
        else:
            print("  dist/IATRO/IATRO")
        return True
...
def main():
    print("=" * 60)
    print("IATRO Executable Builder")
    print("=" * 60)
